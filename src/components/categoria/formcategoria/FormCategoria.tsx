...
placeholder="Ex: Treino de Força, Yoga, Dieta"
...
{/* Input para a Descrição da Categoria*/}
...
value={categoria.descricao || ''} // Exibe o valor do estado. Se for undefined, exibe string vazia.
...
className="rounded text bg-[#FF91e0]

hover:bg-[#F9F5EC] w-1/2 py-2 mx-auto flex justify-center"
